<template>
        ...
        <p>The SCAR CGA is now a relational database - related to the
            <a href="/aadc/mapcat/">SCAR Map catalogue</a>,
            <a href="/aadc/ftc/">SCAR Feature Catalogue</a> and the
            <a href="/aadc/biodiversity/">SCAR Flora and Fauna databases</a> (all developed by the Australian Antarctic Data Centre).
